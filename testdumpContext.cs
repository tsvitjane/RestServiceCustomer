...
{
    public partial class TestDmpDbContext : DbContext
    {
        public TestDmpDbContext()
        {
        }

        public TestDmpDbContext(DbContextOptions<TestDmpDbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;user=root;password=password888;database=test_db", x => x.ServerVersion("8.0.19-mysql"));
            }
        }
